...
void largebreadshop(int &hp, int &money){
    ...
    if (answer == 1 || answer == 2 || answer == 3 || answer == 4 || answer == 5 || answer == 6 || answer == 7)
    {
        ...
        dialogAmt2.push_back("\n    When you swallow bread, a shadow in your body comes out of your\nmouth and makes you suffocate. You see the shadow rushing\ninto the bread oven.\n");
        dialogOutAmt2;
        cout << "\n\'When the dark soul is out you lose 1 hp.\'\n";
        cout << "\n-------------------------------------------------------------------\n";
        cout << "You lose 1 hp.\nYour hp: " << hp << "  (-1)\n";
        cout << "-------------------------------------------------------------------\n";
        dialogOutAmt3;
...
void teashop(int &hp){
    ...
    "\n    The elder returns to the back of the shop and come back\nwith 3 glasses of tea.\n");
    dialogAmt.push_back(
    "\n    The smell is quite terrible. The color looks scary. However,\naccording from what he said, you will decide whether to drink or not.\n");
    dialogOutAmt2;
    dialogOutSlowAmt;
    dialogOutAmt3;
    dialogAmt.clear();
...
void thefirstglass(int &hp){
    ...
    dialogAmt2.push_back("\n   The old man have seen that in the future you will face\ndifficulties. Therefore, he gives you an Amethyst,\nthe \"Crystal of Purity\".\n\n");
    dialogAmt2.push_back("===================================================================\n");
    dialogAmt.push_back("     Amethyst is a powerful negative-energy cleansing properties. It\nalso provides comfort and protection during times of healing.\n");
    dialogAmt3.push_back("===================================================================\n");
    dialogAmt3.push_back("\n*****************************************************************\n");
    dialogOutAmt2;
    dialogOutSlowAmt;
    ...
    pressEnterAmt();
    dialogAmt3.clear();
    dialogAmt2.push_back("     Amethyst is a powerful negative-energy cleansing properties. It\nalso provides comfort and protection during times of healing.\n");
    dialogAmt2.push_back("===================================================================\n");
