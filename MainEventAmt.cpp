...
void Amt(int &hp, int &money, bool &amethyst)
{
    ...
    while (true)
    {
        ...
        pressEnterAmt();
        dialogAmt2.push_back("-------------------------------------------------------------------\n");
        dialogAmt2.push_back("Will you come in?\n");
        dialogAmt2.push_back("1) Yes.\n");
        dialogAmt2.push_back("2) No.\n");
        dialogAmt2.push_back("-------------------------------------------------------------------\n");
        dialogOutAmt2;
        dialogAmt2.clear();
        do
        ...
        if (answer == 1)
        {
            ...
            pressEnterAmt();
            cout << "*****************************************************************\n";
            dialogAmt.push_back("    When waking up early The storm has calmed down. Even though\nyou sleep all night, you don't feel refreshed at all.\nAnd felt that there was no energy Your energy is continuously\ndown in a way that has never been before. \n");
            dialogOutSlowAmt;
            dialogAmt.clear();
            cout << "\n*****************************************************************\n";
            hp -= 1;
...
void largebreadshop()
{
    ...
    if (answer == 1 || answer == 2 || answer == 3 || answer == 4 || answer == 5 || answer == 6 || answer == 7)
    {
        ...
        pressEnterAmt();
        dialogAmt2.push_back("===================================================================\n");
        dialogAmt.push_back("  When you swallow bread, a shadow in your body comes out of your\nmouth and makes you suffocate. You see the shadow rushing\ninto the bread oven.\n");
        dialogAmt3.push_back("===================================================================\n");
        dialogOutAmt2;
        dialogOutSlowAmt;
        dialogOutAmt3;
...
void teashop()
{
    ...
    {
        dialogAmt2.push_back("===================================================================\n");
        dialogAmt.push_back("  You decided to not drink tea. Your symptoms subsided again.\n");
        dialogAmt3.push_back("===================================================================\n");
        dialogOutAmt2;
        dialogOutSlowAmt;
        dialogOutAmt3;
        ...
        {
             dialogAmt2.push_back("===================================================================\n");
            dialogAmt.push_back("  You still decided to not drink the tea. You walked out of this\ntea shop.\n");
            dialogAmt3.push_back("===================================================================\n");
            dialogOutAmt2;
            dialogOutSlowAmt;
            dialogOutAmt3;
...
void thefirstglass()
{
    ...
    dialogAmt2.push_back("*****************************************************************\n");
    dialogAmt.push_back("   The old people have seen that in the future you will be very\n difficult. Therefore gives you an Amethyst,\nthe \"Crystal of Purity\".\n");
    dialogAmt3.push_back("\n*****************************************************************\n");
    dialogOutAmt2;
    dialogOutSlowAmt;
    dialogOutAmt3;
    ...
    pressEnterAmt();
    dialogAmt2.push_back("*****************************************************************\n");
    dialogAmt.push_back("You thank the old man and come out.\n");
    dialogAmt3.push_back("\n*****************************************************************\n");
    dialogOutAmt2;
    dialogOutSlowAmt;
    dialogOutAmt3;
